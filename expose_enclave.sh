...
sleep 5
# Secrets-block
SECRET_VALUE=$(aws secretsmanager get-secret-value --secret-id arn:aws:secretsmanager:us-east-1:734343938194:secret:API_KEY-068KOa --region us-east-1 | jq -r .SecretString)
